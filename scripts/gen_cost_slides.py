...
phases = [
    ...
    ("Phase 3: Enterprise", "12+ months", [
        ...
        "~17 new presentations/month (200/yr)",
...
add_multi_text(slide, Inches(0.5), Inches(1.2), Inches(4.4), Inches(2.6), [
    ...
    {"text": "\u2022 5 new presentations created/month (~60/yr)", "size": 11, "color": DARK_GRAY},
    ...
    {"text": "\u2022 ~10 live Q&A sessions/month (~5 min each)", "size": 11, "color": DARK_GRAY},
...
phase1_data = [
    ...
    ["Batch Avatar Synthesis", "50 min (5 videos)", "$0.50/min", "$25", "24.3%"],
    ["VoiceLive Avatar (live Q&A)", "50 min (10 sessions)", "$0.50/min", "$25", "24.3%"],
    ["Azure OpenAI GPT-4.1", "~300K tokens", "$0.002-0.008/1K", "$2", "1.9%"],
    ["OpenAI Embeddings", "~200K tokens", "$0.02/1M", "$0.004", "<0.1%"],
    ["Container Apps (1vCPU, 2GB)", "24/7 after free tier", "$0.000024/s", "$35", "34.0%"],
    ["Cosmos DB Serverless", "~500K RUs + 0.5 GB", "$0.25/1M RU", "$0.25", "<0.1%"],
    ["Blob Storage (Hot LRS)", "~2 GB (videos+slides)", "$0.018/GB", "$0.04", "<0.1%"],
    ["Container Registry (Basic)", "1 registry", "$5/month", "$5", "4.9%"],
...
add_multi_text(slide, Inches(0.5), Inches(4.3), Inches(4.4), Inches(3.0), [
    ...
    {"text": "Cost per learner: ~$1.86/month", "size": 13, "bold": True, "color": GREEN},
    {"text": "", "size": 6, "space_after": 2},
    {"text": "Annual estimate: ~$1,116", "size": 14, "bold": True, "color": DARK_BLUE},
])
...
add_multi_text(slide, Inches(0.5), Inches(1.2), Inches(4.4), Inches(2.5), [
    ...
    {"text": "\u2022 12 new presentations/month (~140/yr)", "size": 11, "color": DARK_GRAY},
    {"text": "\u2022 Each presentation: ~10 min batch video", "size": 11, "color": DARK_GRAY},
    {"text": "\u2022 ~40 live Q&A sessions/month (~5 min each)", "size": 11, "color": DARK_GRAY},
...
phase2_data = [
    ["Service", "Usage/Month", "Unit Cost", "Monthly Cost", "% of Total"],
    ["Batch Avatar Synthesis", "120 min (12 videos)", "$0.50/min", "$60", "10.5%"],
    ["VoiceLive Avatar (live Q&A)", "200 min (40 sessions)", "$0.50/min", "$100", "17.5%"],
    ["Azure OpenAI GPT-4.1", "~2M tokens", "$0.002-0.008/1K", "$10", "1.8%"],
    ["OpenAI Embeddings", "~1M tokens", "$0.02/1M", "$0.02", "<0.1%"],
    ["Azure AI Translator", "~5M chars", "$10/1M", "$50", "8.8%"],
    ["Container Apps (2vCPU, 4GB)", "24/7, 1 replica", "$0.000024/s", "$155", "27.1%"],
    ["Cosmos DB Serverless", "~3M RUs + 3 GB", "$0.25/1M RU", "$1.50", "0.3%"],
    ["Blob Storage (Hot LRS)", "~10 GB (videos)", "$0.018/GB", "$0.20", "<0.1%"],
    ["Container Registry (Basic)", "1 registry", "$5/month", "$5", "0.9%"],
    ["Log Analytics", "~2 GB logs", "Free 5GB", "$0", "0%"],
    ["AI Search (Basic) \u2014 UC1 Gold", "1 unit", "$73/month", "$73", "12.8%"],
    ["", "", "", "", ""],
    ["TOTAL", "", "", "$455", "100%"],
]
...
add_multi_text(slide, Inches(0.5), Inches(4.2), Inches(4.4), Inches(3.0), [
    ...
    {"text": "", "size": 6, "space_after": 2},
    {"text": "10x learners (50\u2192500) but only ~5x cost. Infrastructure becomes the main cost, not avatar.",
     "size": 12, "bold": True, "color": DARK_GRAY},
    {"text": "", "size": 6, "space_after": 2},
    {"text": "Translation adds $50/mo for 37 languages.",
     "size": 11, "color": MED_GRAY},
    {"text": "AI Search added for UC1 Gold multi-deck retrieval.",
     "size": 11, "color": MED_GRAY},
    {"text": "", "size": 6, "space_after": 2},
    {"text": "Cost per video produced: ~$5", "size": 13, "bold": True, "color": AZURE_BLUE},
    {"text": "Cost per learner: ~$0.91/month", "size": 13, "bold": True, "color": AZURE_BLUE},
    {"text": "", "size": 6, "space_after": 2},
    {"text": "Annual estimate: ~$5,460", "size": 14, "bold": True, "color": DARK_BLUE},
])
...
add_multi_text(slide, Inches(0.5), Inches(1.2), Inches(4.4), Inches(2.5), [
    ...
    {"text": "\u2022 17 new presentations/month (200/year)", "size": 11, "color": DARK_GRAY},
    {"text": "\u2022 Each presentation: ~10 min batch video", "size": 11, "color": DARK_GRAY},
    {"text": "\u2022 ~100 live Q&A sessions/month (~5 min)", "size": 11, "color": DARK_GRAY},
    {"text": "\u2022 UC3: 5 podcasts/month (20 min each)", "size": 11, "color": DARK_GRAY},
...
phase3_data = [
    ["Service", "Usage/Month", "Unit Cost", "Monthly Cost", "% of Total"],
    ["Batch Avatar Synthesis", "170 min (17 videos)", "$0.50/min", "$85", "3.8%"],
    ["VoiceLive Avatar (live Q&A)", "500 min (100 sessions)", "$0.50/min", "$250", "11.1%"],
    ["UC3 Podcast (dual avatar)", "100 min (5 podcasts)", "$0.50/min x2", "$100", "4.4%"],
    ["Custom Avatar Hosting", "1 model, 24/7", "$0.60/hr", "$432", "19.2%"],
    ["Azure OpenAI GPT-4.1", "~10M tokens", "$0.002-0.008/1K", "$50", "2.2%"],
    ["OpenAI Embeddings", "~5M tokens", "$0.02/1M", "$0.10", "<0.1%"],
    ["Azure AI Translator", "~20M chars", "$10/1M", "$200", "8.9%"],
    ["Container Apps (2vCPU, 4GB x3)", "24/7, 3 regions", "$0.000024/s", "$470", "20.9%"],
    ["Cosmos DB Serverless", "~20M RUs + 20 GB", "$0.25/1M RU", "$10", "0.4%"],
    ["Blob Storage (Hot LRS)", "~50 GB (videos)", "$0.018/GB", "$1", "<0.1%"],
    ["AI Search (Standard S1)", "1 unit", "$245/unit", "$245", "10.9%"],
    ["Container Registry (Std)", "1 registry", "$20/month", "$20", "0.9%"],
    ["Log Analytics", "~5 GB logs", "Free 5GB", "$0", "0%"],
    ["Front Door + Key Vault", "Global routing", "~$36/month", "$36", "1.6%"],
    ["", "", "", "", ""],
    ["TOTAL", "", "", "$1,899", "100%"],
]
...
add_multi_text(slide, Inches(0.5), Inches(4.2), Inches(4.4), Inches(2.8), [
    ...
    {"text": "", "size": 6, "space_after": 2},
    {"text": "100x learners (50\u21925,000) but only ~20x cost. Custom avatar hosting becomes the top variable cost.",
     "size": 12, "bold": True, "color": DARK_GRAY},
    {"text": "", "size": 6, "space_after": 2},
    {"text": "Infrastructure (Container Apps, AI Search) is the main cost at this scale \u2014 not avatar rendering.",
     "size": 11, "color": MED_GRAY},
    {"text": "UC3 Podcast adds modest cost ($100/mo for 5 episodes).",
     "size": 11, "color": MED_GRAY},
    {"text": "", "size": 6, "space_after": 2},
    {"text": "Cost per video produced: ~$5", "size": 13, "bold": True, "color": ORANGE},
    {"text": "Cost per learner: ~$0.38/month", "size": 13, "bold": True, "color": ORANGE},
    {"text": "", "size": 6, "space_after": 2},
    {"text": "Annual estimate: ~$22,800", "size": 14, "bold": True, "color": DARK_BLUE},
])
...
summary_data = [
    ...
    ["New Videos/Year", "~60", "~140", "200"],
    ["Use Cases", "UC1 Silver + UC2", "UC1 All + UC2", "UC1 + UC2 + UC3"],
    ["Languages", "10", "37", "37"],
    ["Avatars", "Standard", "Standard", "Standard + Custom"],
    ["Regions", "1", "1", "3"],
    ["", "", "", ""],
    ["Monthly Cost", "$93", "$455", "$1,899"],
    ["Annual Cost", "$1,116", "$5,460", "$22,788"],
    ["Per-Learner/Month", "$1.86", "$0.91", "$0.38"],
    ["Per-Video Produced", "~$5", "~$5", "~$5"],
    ["", "", "", ""],
    ["Avatar Rendering %", "54%", "35%", "23%"],
    ["Infrastructure %", "43%", "51%", "41%"],
    ["AI + Translation %", "3%", "14%", "16%"],
]
...
scenarios_data = [
    ...
    ["Baseline (published rates)", "$455", "\u2014", "$0.91", "Phase 2 with 500 learners"],
    ["EA Discount (20% on Avatar)", "$423", "-$32 (7%)", "$0.85", "Enterprise agreement pricing"],
    ["Shorter videos (7 min avg)", "$437", "-$18 (4%)", "$0.87", "Optimize presentation length"],
    ["TTS audio-only for Q&A", "$355", "-$100 (22%)", "$0.71", "No avatar for Q&A, voice only"],
    ["Scale-to-zero off-hours", "$380", "-$75 (16%)", "$0.76", "Container Apps scale to 0 at night"],
    ["Combined optimistic", "$300", "-$155 (34%)", "$0.60", "EA + audio Q&A + scale-to-zero"],
]
...
tco_data = [
    ...
    ["", "", "", "", ""],
    ["Phase 1 Azure (6 months)", "$558", "\u2014", "\u2014", "$558"],
    ["Phase 2 Azure (6mo Y1 + 12mo Y2)", "$2,730", "$5,460", "\u2014", "$8,190"],
    ["Phase 3 Azure (12 months)", "\u2014", "\u2014", "$22,788", "$22,788"],
    ["", "", "", "", ""],
    ...
    ["", "", "", "", ""],
    ["Support & Operations", "", "", "", ""],
    ["DevOps / SRE (0.25 FTE)", "$25,000", "$25,000", "$25,000", "$75,000"],
    ["", "", "", "", ""],
    ["ANNUAL TOTAL", "$108,288", "$210,460", "$77,788", "$396,536"],
]
...
add_multi_text(slide, Inches(7.0), Inches(1.8), Inches(5.8), Inches(4.5), [
    ...
    {"text": "Engage Microsoft account team for Saint-Gobain-specific Azure AI Speech pricing.",
     "size": 10, "color": DARK_GRAY},
    {"text": "", "size": 6, "space_after": 6},
