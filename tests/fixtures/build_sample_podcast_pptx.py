...
Output: tests/fixtures/acme-innovation-sample.pptx
"""
...
OUT = Path(__file__).parent / "acme-innovation-sample.pptx"

SLIDES = [
    {
        "title": "Acme: Shaping a Sustainable Future",
        "bullets": [
        ...
        "notes": (
            "Welcome to our introduction to Acme. "
    ...
    },
    {
        ...
        "notes": (
            "Acme is organized around four complementary business activities. "
    ...
    },
    {
        ...
        "notes": (
            "So why should you partner with Acme. "
