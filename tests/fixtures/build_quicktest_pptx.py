...
OUT = Path(__file__).parent / "saint-gobain-quicktest.pptx"

SLIDES = [
    {
        "title": "Saint-Gobain in 30 Seconds",
        "bullets": ["360 years of materials innovation", "76 countries, 160k employees"],
        "notes": "Saint-Gobain is a global leader in sustainable construction, present in 76 countries with 160,000 employees.",
    },
    {
